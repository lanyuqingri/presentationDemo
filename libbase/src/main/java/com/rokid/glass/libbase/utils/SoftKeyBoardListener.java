...
public class SoftKeyBoardListener {
    ...
    public static int DEFAULT_SOFTKEYBOARD_HEIGHT = (int) (SizeUtils.getHeight() * 0.42);
    ...
    private SoftKeyBoardListener(final Activity activity) {
        final int screenHeight = SizeUtils.getHeight();
        //获取activity的根视图
